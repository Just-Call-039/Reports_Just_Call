...
with open('my_del.txt', 'a') as file:
    ...
    client.execute("alter table otchet_25 delete where toDate(my_date) between '2022-05-20' and '2022-05-23';")
    ...
    client.execute("alter table request_25 delete where toDate(date_reguest) between '2022-05-20' and '2022-05-23';")
