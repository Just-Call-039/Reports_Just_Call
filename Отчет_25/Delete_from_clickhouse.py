...
with open('my_del.txt', 'a') as file:
    ...
    client.execute("alter table otchet_25 delete where toDate(my_date) between '2022-10-18' and '2022-10-25';")
    ...
    client.execute("alter table request_25 delete where toDate(date_reguest) between '2022-10-18' and '2022-10-25';")
