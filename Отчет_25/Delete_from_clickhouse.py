...
with open('my_del.txt', 'a') as file:
    ...
    client.execute("alter table otchet_25 delete where toDate(my_date) between '2022-06-07' and '2022-06-08';")
    ...
    client.execute("alter table request_25 delete where toDate(date_reguest) between '2022-06-07' and '2022-06-08';")
